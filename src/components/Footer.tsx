...
const footerSections = {
  ...
  layanan: {
    ...
    links: [
      ...
      {
        name: "Pengabdian Universitas Lampung",
        href: "https://silemlit21.unila.ac.id/",
        external: true,
        description: "Akses Portal",
      },
      {
        ...
        href: "https://ejurnal.unila.ac.id",
        external: true,
        description: "Akses Portal",
      },
      {
        name: "Journal Ilmiah dan Publikasi",
        href: "https://ejurnal.unila.ac.id/",
        external: true,
        description: "Akses Portal",
      },
      {
        name: "National Seminar and International",
        href: "https://conference.lppm.unila.ac.id/",
        external: true,
        description: "Akses Portal",
      },
    ],
