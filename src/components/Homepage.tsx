      ...
      <section className="relative bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/30 py-20 overflow-hidden">
        ...
        <div className="relative max-w-screen-2xl mx-auto px-4 sm:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            {[
              {
                title: "Penelitian Universitas Lampung",
                icon: `${import.meta.env.BASE_URL}icons/penelitian.png`,
                color: "from-blue-500 to-blue-600",
                description: "",
                link: "https://silemlit21.unila.ac.id/",
                gradient: "from-blue-500/10 to-blue-600/10",
                borderColor: "border-blue-200",
              },
              {
                title: "Pengabdian Universitas Lampung",
              ...
              {
                title: "Repository Karya Ilmiah",
                icon: `${import.meta.env.BASE_URL}icons/repository.png`,
                color: "from-purple-500 to-purple-600",
                description: "",
                link: "https://ejurnal.unila.ac.id",
                external: true,
                gradient: "from-purple-500/10 to-purple-600/10",
                borderColor: "border-purple-200",
              },
              {
                title: "Journal Ilmiah dan Publikasi",
              ...
              {
                title: "National Seminar and International",
                icon: `${import.meta.env.BASE_URL}icons/ppid.png`,
                color: "from-red-500 to-red-600",
                description: "",
                link: "https://conference.lppm.unila.ac.id/",
                external: true,
